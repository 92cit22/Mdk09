...
var Timer = /** @class */ (function () {
    function Timer(updateTime, startHours, startMinutes, startSeconds) {
        var _this = this;
        if (updateTime === void 0) { updateTime = 1000; }
        if (startHours === void 0) { startHours = 0; }
        if (startMinutes === void 0) { startMinutes = 0; }
        if (startSeconds === void 0) { startSeconds = 0; }
        this.updateTime = 0;
        this.interval = 0;
        this.isRun = false;
        this.observers = [];
    ...
    Timer.prototype.speedDown = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.updateTime += 10;
                this.updateInterval();
    ...
    Timer.prototype.updateInterval = function () {
